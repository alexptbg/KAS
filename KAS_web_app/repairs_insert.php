                    ...
                    <div class="col-lg-12">
                            <?php
								if(isset($_POST['submit'])) {
									...
									if (($uk_router != NULL) && ($uk_inv != NULL)) {
										//try to insert
		                                $query = "INSERT INTO `maintenance` (`date`, `router`, `inv`, `who`, `user`, `action`, `obs`) 
										          VALUES ('".$uk_date."','".$uk_router."','".$uk_inv."','".$uk_who."','".$user_settings['user_name']."','".$uk_action."','".$uk_obs."')";
                                        $result = mysql_query($query);
                                        confirm_query($result);
                                        if ($result) {
                                        	//inserted
