                            ...
                            <?php
								if(isset($_POST['submit'])) {
									...
									if (($uk_id != NULL) && ($uk_inv != NULL)) {
										//try to update
		                                $query = "UPDATE `maintenance` SET `date`='".$uk_date."', `router`='".$uk_router."', `inv`='".$uk_inv."', `user`='".$u."', `action`='".$uk_action."', `obs`='".$uk_obs."' WHERE `id`='".$rid."' AND `inv`='".$uk_inv."'";
                                        $result = mysql_query($query);
                                        confirm_query($result);
                                        if ($result) {
                                        	//inserted
