...
$k_repair = get_klima_repair($k,$id);
?>
<head>
        <title><?=$slogan?></title>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <?php echo get_lang($lang,'k280'); ?>
                            </div>
							<form method="POST" action="klimatiki_repairs_update.php?lang=<?=$lang?>&klima=<?=$k?>&user=<?=$u?>&r=<?=$r?>&rid=<?=$id?>" id="forms">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control validate[required]" type="text" name="router" value="<?php echo $r; ?>" readonly="readonly" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang,'k51'); ?>:</label>
                                    <input class="form-control validate[required]" type="text" name="inv" value="<?php echo $k_settings['inv']; ?>" readonly="readonly" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang,'k117'); ?>:</label>
                                    <input class="form-control validate[required]" type="text" name="date" value="<?php echo $k_repair['date']; ?>" readonly="readonly" id="datetimepicker" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang,'k180'); ?>:</label>
                                    <textarea class="form-control validate[required,minSize[10]]" name="action" rows="2"><?php echo $k_repair['action']; ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang,'k283'); ?>:</label>
                                    <textarea class="form-control validate[required]" name="obs" rows="2"><?php echo $k_repair['obs']; ?></textarea>
                                </div>
                            </div>
