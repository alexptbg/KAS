                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <?php echo get_lang($lang, 'k26'); ?>&nbsp;<?php echo $r_settings['router_name']; ?>
                            </div>
							<form method="POST" action="routers_update.php?lang=<?=$lang?>&router_old=<?=$router?>" id="forms">
                            <div class="panel-body">
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k27'); ?>:</label>
                                    <input class="form-control" type="text" name="id" value="<?php echo $r_settings['id']; ?>" readonly="readonly" />
                                </div>
								<?php if ($user_settings['level'] > 20): ?>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k15'); ?>:</label>
                                    <input class="form-control validate[required]" maxlength="32" type="text" name="router_name" value="<?php echo $r_settings['router_name']; ?>" />
                                </div>
								<?php else: ?>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k15'); ?>:</label>
                                    <input class="form-control validate[required]" maxlength="32" type="text" name="router_name" value="<?php echo $r_settings['router_name']; ?>" readonly="readonly" />
                                </div>
								<?php endif; ?>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k16'); ?>:</label>
                                    <input class="form-control validate[required]" maxlength="10" type="text" name="router_sname" value="<?php echo $r_settings['router_sname']; ?>" oninput="document.getElementById('echo').value=this.value+'.php';" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k17'); ?>:</label>
                                    <input class="form-control" type="text" name="data_file" value="<?php echo $r_settings['data_file']; ?>" id="echo" readonly="readonly" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k18'); ?>:</label>
                                    <input class="form-control validate[required,custom[ipv4]]" maxlength="15" type="text" name="ip_address" value="<?php echo $r_settings['ip_address']; ?>" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k19'); ?>:</label>
                                    <input class="form-control validate[required,custom[onlyNnumbers]]" maxlength="5" type="text" name="port" value="<?php echo $r_settings['port']; ?>" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k20'); ?>:</label>
                                    <input class="form-control" type="text" name="ex_table" maxlength="128" value="<?php echo $r_settings['ex_table']; ?>" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k21'); ?>:</label>
                                    <input class="form-control" type="text" name="place" maxlength="48" value="<?php echo $r_settings['place']; ?>" />
                                </div>
                            </div>
                            <div class="panel-footer">
                                <button type="button" class="btn btn-primary btn-lg" onClick="document.location.href = 'routers.php?lang=<?=$lang?>&router=<?=$router?>&id=<?=$id?>'; return false;">
