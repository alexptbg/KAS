								...
								if(isset($_POST['submit'])) {
									...
									if ($dsure == 'yes') {
                                        ...
                                        if ($result) {
			                                ...
			                                insert_log($lang,$SYS,$user_settings['user_name'],'error','k296',$obs);
                                            echo "<div class=\"panel panel-primary\">";
                                            echo "<div class=\"panel-heading\">
                                                      ".get_lang($lang,'k294')."
                                                  </div>";
										    echo "<div class=\"panel-body\"><div class=\"alert alert-success\">";
                                            echo get_lang($lang, 'k296');
                                            echo "</div></div></div>";
                                            ...
                                            echo "<button type=\"button\" class=\"btn btn-primary btn-lg\" onClick=\"document.location.href = 'repairs.php?lang=".$lang."'\"><i class=\"fa fa-arrow-left\"></i>&nbsp;".get_lang($lang,'k34')."</button>";
                                            echo "</div></div>";
										}
									} else {
									//error not deleted
