                ...
                <div class=\"row\">
                    <div class=\"col-lg-12\">
                        <div class=\"panel panel-warning\">
                            <div class=\"panel-heading\">".get_lang($lang,'k160')."</div>
							<form method=\"POST\" action=\"settings_adv_update.php?lang=".$lang."\" id=\"forms\">
                            <div class=\"panel-body\">
                                <div class=\"form-group\">
                                    <input class=\"form-control\" type=\"hidden\" name=\"id\" value=\"".$s_settings['id']."\" readonly=\"readonly\" />
                                </div>
                                <div class=\"form-group\">
                                    <label>".get_lang($lang, 'k155').":</label>
                                    <input class=\"form-control validate[required]\" maxlength=\"48\" type=\"text\" name=\"system_name\" value=\"".$s_settings['system_name']."\" />
                                </div>
                                <div class=\"form-group\">
                                    <label>".get_lang($lang, 'k180').":</label>
                                    <input class=\"form-control validate[required]\" maxlength=\"96\" type=\"text\" name=\"desc\" value=\"".$s_settings['desc']."\" />
                                </div>
                                <div class=\"form-group\">
                                    <label>".get_lang($lang, 'k156').":</label>
                                    <input class=\"form-control validate[required]\" maxlength=\"5\" type=\"text\" name=\"slogan\" value=\"".$s_settings['slogan']."\" />
                                </div>
                                <div class=\"form-group\">
                                    <label>".get_lang($lang, 'k157').":</label>
                                    <input class=\"form-control validate[required]\" maxlength=\"48\" type=\"text\" name=\"base\" value=\"".$s_settings['base']."\" />
                                </div>
                                <div class=\"form-group\">
                                    <label>".get_lang($lang, 'k158').":</label>
                                    <input class=\"form-control validate[required]\" maxlength=\"32\" type=\"text\" name=\"sub_dir\" value=\"".$s_settings['sub_dir']."\" />
                                </div>
                                <div class=\"form-group\">
                                    <label>Copyrights:</label>
                                    <input class=\"form-control validate[required]\" maxlength=\"256\" type=\"text\" name=\"copyrights\" value=\"".$s_settings['copyrights']."\" />
                                </div>
                            </div>
                            <div class=\"panel-footer\">
                                <button type=\"button\" class=\"btn btn-primary btn-lg\" onClick=\"document.location.href = 'settings.php?lang=".$lang."'; return false;\">
