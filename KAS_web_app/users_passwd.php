                    ...
                    <div class="col-lg-12">
                            <?php
								if(isset($_POST['submit'])) {
									...
									$ruser_name = mysql_prep($_POST['user_name']);
									$rpassword = mysql_prep($_POST['password']);
									$rpassword2 = mysql_prep($_POST['password2']);
									$rsure = mysql_prep($_POST['sure']);
									$rpasswd1 = md5($rpassword); 
									$rpasswd2 = md5($rpassword2);
									if (($ruser_name != NULL) && ($rpasswd1 == $rpasswd2)) {
										//try to update password
	                                    mysql_query("SET NAMES utf8");
		                                $query = "UPDATE `users` SET `h_password`='$rpasswd2' WHERE `id`='$uid' AND `user_name`='$ruser_name'";
                                        $result = mysql_query($query);
                                        confirm_query($result);
                                        if ($result) {
										...
										//can't update //passwords do not match
                                        echo "<div class=\"panel panel-primary\">";
                                        echo "<div class=\"panel-heading\">
                                                      ".get_lang($lang, 'k111')."
                                                  </div>";
