                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <?php echo get_lang($lang, 'k58'); ?>&nbsp;<?php echo $klimatik['inv']; ?>
                            </div>
							<form method="POST" action="klimatiki_remove.php?lang=<?=$lang?>&router=<?=$router?>&id=<?=$id?>" id="forms">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="k_inv" value="<?php echo $klimatik['inv']; ?>" readonly="readonly" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k36'); ?></label>
