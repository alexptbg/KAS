                    ...
                    <div class="col-lg-12">
                            <?php
								if(isset($_POST['submit'])) {
									...
									$utrack = mysql_prep($_POST['track']);
									$utemp_track = mysql_prep($_POST['temp_track']);
									if ($uid != NULL) {
										//try to update
	                                    mysql_query("SET NAMES utf8");
		                                $query = "UPDATE `settings` SET `track`='".$utrack."', `temp_track`='".$utemp_track."' WHERE `id`='".$uid."'";
                                        $result = mysql_query($query);
                                        confirm_query($result);
                                        if ($result) {
