(function ($) {
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength, iMaxLenght) {
            ...
            var input = $('<input type="text" class="span12 ' + search_init + sCSSClass + '" value="' + inputvalue + '" rel="' + i + '"/>');
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel, bRegex, oSelected) {
            ...
            var r = '<select class="span4 search_init select_filter" rel="' + i + '"><option value="" class="search_init">' + sLabel + '</option>';
            var j = 0;
        ...
        function fnCreateSelect(oTable, aData, bRegex, oSelected) {
                    ...
                    "fn": (function (iColumn, nTh, sLabel) {
                        return function () {
                            if (oSettings.iDraw == 2 && oSettings.sAjaxSource != null && oSettings.sAjaxSource != "" && !oSettings.oFeatures.bServerSide) {
                                return fnCreateColumnSelect(oTable, null, _fnColumnIndex(iColumn), nTh, sLabel, bRegex, oSelected);
                            }
                        };
                    })(i, th, label),
            ...
            fnCreateColumnSelect(oTable, aData, _fnColumnIndex(i), th, label, bRegex, oSelected);
        }
