    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header text-asbestos"><i class="fa fa-location-arrow"></i> <?php echo get_lang($lang, 'k130'); ?></h3>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">
                                                    <?php echo "Strellson/Joop"; ?> \ <?php echo get_lang($lang,'k44'); ?> 1</h4>
                                            </div>
                                            <div class="modal-body">
                                                <img src="img/vrf1.jpg" width="100%" class="vrf2" />
                                            </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                <h4 class="modal-title" id="myModalLabel">
                                                    <?php echo "Strellson/Joop"; ?> \ <?php echo get_lang($lang,'k44'); ?> 2</h4>
                                            </div>
                                            <div class="modal-body">
                                                <img src="img/vrf2.jpg" width="100%" class="vrf2" />
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary" data-dismiss="modal">
                                                    <i class="fa fa-sign-in"></i>&nbsp;&nbsp;OK</button>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
							    <?php echo "Strellson/Joop"; ?> \ <?php echo get_lang($lang,'k131'); ?>
							</div>
                            <div class="panel-body">
                                <img src="img/vrf3.jpg" width="100%" class="vrf3" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
							    <?php echo "Boss"; ?> \ <?php echo get_lang($lang,'k131'); ?>
							</div>
                            <div class="panel-body">
