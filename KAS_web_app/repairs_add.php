                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            ...
                            <!-- form init-->
                            <form role="form" method="POST" action="repairs_insert.php?lang=<?=$lang?>" id="forms">
                            <div class="panel-body">
                                <div class="form-group">
                                    <label><?php echo get_lang($lang,'k117'); ?>:</label>
                                    <input class="form-control validate[required]" type="text" name="date" value="<?php echo date("Y-m-d"); ?>" readonly="readonly" id="datetimepicker" />
                                </div>
                            <?php
                            //routers
                            $query = "SELECT `router_name` FROM `routers` ORDER BY `router_name` ASC";
                            ...
                            if (mysql_num_rows($result) != 0) {
								echo "
                                <div class=\"form-group\">
                                    <label>".get_lang($lang,'k14').":</label>
                                    <select class=\"form-control validate[required]\" name=\"router\">
                                        <option></option>";
								while($repair_routers = mysql_fetch_array($result)) {
									echo "
									    <option value=\"".$repair_routers['router_name']."\">".$repair_routers['router_name']."</option>
									";
								}
								echo "
                                    </select>
							...
							//klimas by selected router above
							echo "
                                <div class=\"form-group\">
                            ...
                            ?>
                                <div class="form-group">
                                    ...
                                    <input class="form-control validate[required]" type="text" name="who" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang,'k180'); ?>:</label>
                                    <textarea class="form-control validate[required,minSize[10]]" name="action" rows="2"></textarea>
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang,'k283'); ?>:</label>
                                    <textarea class="form-control validate[required]" name="obs" rows="2"></textarea>
                                </div>
                            </div>
                            <div class="panel-footer">
								...
								<button type="submit" name="submit" class="btn btn-warning btn-lg">
								    <i class="fa fa-plus"></i>&nbsp;<?php echo get_lang($lang,'k282'); ?></button>
                            </div>
                            </form>
                            <!-- form end-->
                        </div>
