                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <?php echo get_lang($lang, 'k170')."&nbsp;<strong>".$user."</strong>";  ?>
                            </div>
							<form method="POST" action="logs_user_remove.php?lang=<?=$lang?>&user=<?=$user?>" id="forms">
                            <div class="panel-body">
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k171')."&nbsp;<strong>".$user."</strong>?"; ?></label>
