	...
	*/
	...
	function phase_name() {
		...
		if ($lang == 'en') {
			...
			$names = array('Нова Луна','Растяща Луна','Първа Четвърт','Нарастваща Луна','Пълнолуние','Намаляваща Луна','Последна Четвърт','Балсамична Луна','Нова Луна');
		}
