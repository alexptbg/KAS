        ...
        <div id="wrapper">
            <nav class="navbar navbar-default navbar-static-top" role="navigation">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li>
                        <a href="users_add.php?lang=<?=$lang?>">
                ...
                <div class=\"row\">
                    <div class=\"col-lg-12\">
                        <div class=\"panel panel-primary\">
                            <div class=\"panel-heading\">".get_lang($lang, 'k12')."</div>
		                ...
		                while($users = mysql_fetch_array($result)) {
							...
							echo "
							    <tr>
									...
									//controls
									echo "<td>
									          <button type=\"button\" class=\"btn btn-info btn-sm\" onClick=\"document.location.href = 'users_view.php?lang=".$lang."&user=".$users['user_name']."&uid=".$users['id']."'\"><i class=\"fa fa-eye\"></i></button>";
										if (($user_settings['level'] > 10) && ($user_settings['level'] < 50) && ($users['level'] < 20)) { 
										echo "	  
									          <button type=\"button\" class=\"btn btn-warning btn-sm\" onClick=\"document.location.href = 'users_edit.php?lang=".$lang."&user=".$users['user_name']."&uid=".$users['id']."'\"><i class=\"fa fa-edit\"></i></button>";
									...
									if ($user_settings['level'] > 20) {
											  echo "
											  <button type=\"button\" class=\"btn btn-danger btn-sm\" onClick=\"document.location.href = 'users_reset.php?lang=".$lang."&user=".$users['user_name']."&uid=".$users['id']."'\"><i class=\"fa fa-key\"></i></button>
											  <button type=\"button\" class=\"btn btn-danger btn-sm\" onClick=\"document.location.href = 'users_del.php?lang=".$lang."&user=".$users['user_name']."&uid=".$users['id']."'\"><i class=\"fa fa-trash-o\"></i></button>";
									}
								echo "</td>															
					             </tr>";
							}
