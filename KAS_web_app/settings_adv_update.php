                    ...
                    <div class="col-lg-12">
                            <?php
								if(isset($_POST['submit'])) {
									...
									$usystem_name = mysql_prep($_POST['system_name']);
									$udesc = mysql_prep($_POST['desc']);
									$uslogan = mysql_prep($_POST['slogan']);
									$ubase = mysql_prep($_POST['base']);
									$usub_dir = mysql_prep($_POST['sub_dir']);
                                    $ucopyrights = mysql_prep($_POST['copyrights']);
									if ($uid != NULL) {
										//try to update
	                                    mysql_query("SET NAMES utf8");
		                                $query = "UPDATE `settings` SET `system_name`='$usystem_name', `desc`='$udesc', `slogan`='$uslogan', `base`='$ubase', `sub_dir`='$usub_dir', `copyrights`='$ucopyrights'  WHERE `id`='$uid'";
                                        $result = mysql_query($query);
                                        confirm_query($result);
                                        if ($result) {
