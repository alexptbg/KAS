                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <?php echo get_lang($lang, 'k37'); ?>&nbsp;<?php echo $r_settings['router_name']; ?>
                            </div>
							<form method="POST" action="routers_remove.php?lang=<?=$lang?>" id="forms">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="router_name" value="<?php echo $r_settings['router_name']; ?>" readonly="readonly" />
                                </div>
                                <div class="form-group">
