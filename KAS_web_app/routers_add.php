                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <?php echo get_lang($lang, 'k38'); ?>
                            </div>
							<form method="POST" action="routers_insert.php?lang=<?=$lang?>" id="forms">
                            <div class="panel-body">
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k15'); ?>:</label>
                                    <input class="form-control validate[required]" maxlength="32" type="text" name="router_name" value="" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k16'); ?>:</label>
                                    <input class="form-control validate[required]" maxlength="10" type="text" name="router_sname" value="" oninput="document.getElementById('echo').value=this.value+'.php';" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k17'); ?>:</label>
                                    <input class="form-control" type="text" name="data_file" value="" id="echo" readonly="readonly" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k18'); ?>:</label>
                                    <input class="form-control validate[required,custom[ipv4]]" maxlength="15" type="text" name="ip_address" value="" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k19'); ?>:</label>
                                    <input class="form-control validate[required,custom[onlyNnumbers],custom[integer],min[100],custom[integer],max[10000],minSize[3],maxSize[5]]" maxlength="5" type="text" name="port" value="" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k20'); ?>:</label>
                                    <input class="form-control" type="text" name="ex_table" maxlength="128" value="" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k21'); ?>:</label>
                                    <input class="form-control" type="text" name="place" maxlength="48" value="" />
                                </div>
                            </div>
                            <div class="panel-footer">
                                <button type="button" class="btn btn-primary btn-lg" onClick="document.location.href = 'routers.php?lang=<?=$lang?>'; return false;">
								    <i class="fa fa-times"></i>&nbsp;<?php echo get_lang($lang, 'k28'); ?></button>
								<button type="submit" name="submit" class="btn btn-warning btn-lg">
								    <i class="fa fa-plus"></i>&nbsp;<?php echo get_lang($lang, 'k24'); ?></button>
                            </div>
							</form>
                        </div>
                    </div>
