...
$kinv = mysql_prep($_GET['kinv']);
$kid = mysql_prep($_GET['kid']);
$klimatik = get_klimatik_settings($kid,$kinv);
?>
<head>
        <title><?=$slogan?></title>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="repairs.php?lang=<?=$lang?>"><?php echo get_lang($lang,'k284'); ?></a>
                                </li>
								<?php if ($user_settings['level'] > 20): ?>
                                <li>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <?php echo get_lang($lang, 'k54'); ?>
                            </div>
							<form method="POST" action="klimatiki_update.php?lang=<?=$lang?>&router=<?=$router?>&id=<?=$id?>" id="forms">
                            <div class="panel-body">
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k27'); ?>:</label>
                                    <input class="form-control" type="text" name="k_id" value="<?php echo $klimatik['id']; ?>" readonly="readonly" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k14'); ?>:</label>
                                    <input class="form-control validate[required]" maxlength="32" type="text" name="k_router" value="<?php echo $klimatik['router']; ?>" readonly="readonly" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k51'); ?>:</label>
                                    <input class="form-control validate[required,custom[onlyNnumbers]]" maxlength="6" type="text" name="inv" value="<?php echo $klimatik['inv']; ?>" />
                                </div>
                                <div class="form-group">
                                    <label>RTU:</label>
                                    <select class="form-control validate[required]" name="rtu">
									    <option value="<?php echo $klimatik['rtu']; ?>"><?php echo $klimatik['rtu']; ?></option>
									    <option></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control validate[required]" name="addr">
									    <option value="<?php echo $klimatik['addr']; ?>"><?php echo $klimatik['addr']; ?></option>
									    <option></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control validate[required]" name="building">
									    <option value="<?php echo $klimatik['building']; ?>"><?php echo $klimatik['building']; ?></option>
									    <option></option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
										<option value="3">3</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control validate[required]" name="floor">
									    <option value="<?php echo $klimatik['floor']; ?>"><?php echo $klimatik['floor']; ?></option>
									    <option></option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
										<option value="3">3</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control validate[required,custom[onlyNnumbers]]" maxlength="6" type="text" name="group" value="<?php echo $klimatik['group']; ?>" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k46'); ?>:</label>
                                    <input class="form-control validate[required]" type="text" name="zona" maxlength="32" value="<?php echo $klimatik['zona']; ?>" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k47'); ?>:</label>
                                    <input class="form-control validate[required]" type="text" name="place" maxlength="48" value="<?php echo $klimatik['place']; ?>" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k104'); ?>:</label>
                                    <select class="form-control validate[required]" name="type">
									    <?php if ($klimatik['type'] == "1"): ?>
									    <option value="<?php echo $klimatik['type']; ?>"><?php echo get_lang($lang, 'k68'); ?></option>
									    <?php elseif ($klimatik['type'] == "2"): ?>
									    <option value="<?php echo $klimatik['type']; ?>"><?php echo get_lang($lang, 'k105'); ?></option>
										<?php endif; ?>	
									    <option></option>
                                ...
                                <div class="form-group">
                                    <label>VRF:</label>
                                    <input class="form-control validate[required,custom[number]]" type="text" name="vrf" maxlength="4" value="<?php echo $klimatik['vrf']; ?>" />
                                </div>
								
                                <div class="form-group">
                                    <label><?php echo get_lang($lang, 'k132'); ?>:</label>
                                    <select class="form-control validate[required]" id="prog" name="prog">
									    <option value="<?php echo $klimatik['prog']; ?>"><?php echo get_lang($lang,lcfirst($klimatik['prog'])); ?></option>
									    <option></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control validate[required]" id="time_start_w" name="start_w">
									    <option value="<?php echo $klimatik['start_w']; ?>"><?php echo $klimatik['start_w']; ?></option>
									    <option></option>
                                    ...
                                    <select class="form-control validate[required]" id="time_stop_w" name="stop_w">
									    <option value="<?php echo $klimatik['stop_w']; ?>"><?php echo $klimatik['stop_w']; ?></option>
									    <option></option>
                                        <option value="06:00">06:00</option>
                                        <option value="06:30">06:30</option>
                                        <option value="07:00">07:00</option>
                                    ...
                                    <select class="form-control validate[required]" id="time_start_s" name="start_s">
									    <option value="<?php echo $klimatik['start_s']; ?>"><?php echo $klimatik['start_s']; ?></option>
									    <option></option>
                                        <option value="05:30">05:30</option>
                                        <option value="06:00">06:00</option>
                                        <option value="06:30">06:30</option>
                                    ...
                                    <select class="form-control validate[required]" id="time_stop_s" name="stop_s">
									    <option value="<?php echo $klimatik['stop_s']; ?>"><?php echo $klimatik['stop_s']; ?></option>
									    <option></option>
                                        <option value="06:00">06:00</option>
                                        <option value="06:30">06:30</option>
                                        <option value="07:00">07:00</option>
