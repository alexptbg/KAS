    ...
    <body>
        <div id="wrapper">
            ...
            <nav class="navbar-default navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="vrf_errors.php?lang=<?=$lang?>" class="active">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header text-asbestos"><i class="fa fa-exclamation-triangle"></i>&nbsp;<?php echo get_lang($lang,'k201'); ?></h3>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-warning">
                            <div class="panel-heading">
							    <?php echo get_lang($lang,'k202'); ?>&nbsp;E
							</div>
                            <div class="panel-body">
                                <img src="img/e.jpg" width="100%" class="vrfe" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="panel panel-warning">
                            <div class="panel-heading">
							    <?php echo get_lang($lang,'k202'); ?>&nbsp;F
							</div>
                            <div class="panel-body">
                                <img src="img/f.jpg" width="100%" class="vrff" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="panel panel-warning">
                            <div class="panel-heading">
							    <?php echo get_lang($lang,'k203'); ?>
							</div>
                            <div class="panel-body">
                                <img src="img/w1.jpg" width="100%" class="vrfw" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="panel panel-warning">
                            ...
                            <div class="panel-body">
                                <img src="img/w2.jpg" width="100%" class="vrfw" />
                            </div>
                        </div>
                    </div>
                </div>
